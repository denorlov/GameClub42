...
txt = '''                        __________ПРАВИЛА И ЗАМЕТКИ_______________________________
                    ...
                    3) Если вы заблудитесь, то в любой момент можно взглянуть на карту!
                       Для этого, напишите в поле ввода "карта", появится окно с необходимой 
                       информацией. Чтобы продолжить играть, просто закройте окно.
