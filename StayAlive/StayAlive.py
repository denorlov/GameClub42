...
while restart:
    ...
    print('''                             ________________________ПРАВИЛА И ЗАМЕТКИ__________________________
                                  1) Всегда можно осмотреть помещение. Для успешного прохождения
                                     данной мини-инры вы не должны забывать делать это.
                                  2) В этой игре 3 концовки, чтобы посмотреть их все, нужно играть!
                                  3) Поддержать разработчиков ---> Qiwi +7-903-667-16-41''')
    print()
    print()
    ...
    print('Короче, мы с тобой остались одни в лаборатории, полной диких мутантов.')
    ...
    print('Думаю, ты понял, что нам нужно выбираться от сюда.')
    print('Оглянувшись, вы не нашли ничего, кроме колб с разноцветными веществами и '
          'многочисленных стопок бумаг, разбросанных по помещению. Подняв одну из них,'
          ' вы узнали свой почерк. Похоже, это ваш кабинет.')
    ...
    while not game_over and not game_win:
        if location == 'начало':
            ...
            while True:
                direction = input()
                if '1' in direction or '2' in direction or '3' in direction or 'смотр' \
                                                                               '' in direction.lower():
                    break
            ...
            pygame.mixer.music.play(-1)
            print('Вы зашли в тёмную комнату,через некоторое время, вы почувствовали,'
                  ' что кто-то на вас прыгнул, вцепился клыками в шею и вы потеряли'
                  ' сознание!.')
            time.sleep(5)
            game_over = True
    ...
    input('Press ENTER to continue')
    print('\n' * 100)
    print('Хотите поиграть заного?')
    say = input()
    if 'не' in say.lower():
        print('Хорошо, до скорых встреч!')
        time.sleep(2)
        print('\n' * 100)
        print('Поддержать разработчиков ---> Qiwi +7-903-667-16-41')
        print()
        print()
    else:
        location = 'начало'
