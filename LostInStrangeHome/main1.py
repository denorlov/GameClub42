...
rooms = {
    'Зал': {
        'description': "Все здесь, конечно, странно обставленно. "
                       "Паутина, старое скрипучее кресло-качалка. "
                       "Еще здесь много-много пыли. "
                       "И как это путник, тебя сюда занесло?",
        'юг': 'Кухня',
        'запад': 'Столовая',
        'item': ['ключ']
    },
    ...
    'Кухня': {
        'description': "На кухне на плите стоит пара кастрюл. "
                       "И в одной из кастрюль что-то жарится! "
                       "Вонь стоит ужасная. Кто, интересно, может "
                       "есть такую тухлятину?!",
        'север': 'Зал',
        'item': ['monster']
    },

    'Столовая': {
        'description': "В центре комнаты расположен огромный стол, "
                       "на столе расставлены огромные, если не сказать гигансткие приборы. "
                       "И еще кто-то собирался ужинать при свечах. "
                       "На столе, на всех предметах мебели расставлены канделябры "
